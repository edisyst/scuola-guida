...
| **Service** | Tutta la business logic (14 service: Quiz, QuizAttempt, QuizEnrollment, QuizSummary, Question, User, UserRegistration, UserStats, DashboardStats, RolePermission, Search, Study, Notification, ReviewErrors). |
