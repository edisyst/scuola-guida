...
| **Service** | Tutta la business logic (17 service: Quiz, QuizAttempt, QuizEnrollment, QuizSummary, Question, User, UserRegistration, UserStats, DashboardStats, RolePermission, Search, Study, Notification, ReviewErrors, CategoryMaterial, DiagnosticService, StudyPlanService). |
