...
@section('page-title', __('study_content.title_create'))
...
<div class="sg-wrapper">
    ...
    <div class="sg-header mb-3">
        <h1 class="sg-header-title">
            <i class="fas fa-book mr-2"></i> {{ __('study_content.title_create') }}
        </h1>
    </div>

    <form method="POST" action="{{ route('study-contents.store') }}">
        @csrf
        @include('study-contents._form', ['studyContent' => null])
    </form>
