...
<section class="d-flex align-items-center text-white"
         style="min-height:60vh;background:linear-gradient(135deg,var(--sg-accent) 0%,#2c6fad 100%);">
...
<section class="py-5" :class="dark ? 'bg-dark' : 'bg-white'">
    <div class="container">
        <div class="row g-4 justify-content-center">
            @if($stats['quiz_count'] > 0)
            <div class="col-md-4">
                <div class="card text-center h-100 border-0 shadow-sm"
                     :class="dark ? 'bg-secondary text-white' : ''">
...
{{-- ============================================================
     ...
     ============================================================ --}}
<section class="py-5" :class="dark ? 'bg-dark text-white' : 'bg-light'">
    <div class="container">
...
<section class="py-5" :class="dark ? 'bg-dark text-white' : 'bg-white'">
...
{{-- ============================================================
     ...
     ============================================================ --}}
<section class="py-5 text-center" :class="dark ? 'bg-dark text-white' : 'bg-light'">
    <div class="container">
