<div>
    @if($completed)
        ...
        <div class="text-center p-5">
            ...
            <h3 class="mt-3">Test completato!</h3>
            <p class="text-muted">Abbiamo elaborato le tue risposte per costruire il piano di studio personalizzato.</p>
            <a href="{{ route('viewer.study-plan.show') }}" class="sg-btn sg-btn-primary mt-3">
                <i class="fas fa-route"></i> Vai al piano di studio
            </a>
        </div>
    ...
    @else
        ...
        <div class="text-center p-5">
            ...
            <h3 class="mt-3">Nessuna domanda disponibile</h3>
            <p class="text-muted">Non ci sono domande disponibili per il test diagnostico in questo momento.</p>
            <a href="{{ route('study.index') }}" class="sg-btn sg-btn-primary mt-2">
                <i class="fas fa-graduation-cap mr-1"></i> Vai alla modalità studio
            </a>
        </div>
